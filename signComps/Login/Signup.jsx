...
import {Box, Button, Checkbox, FormControl, FormLabel, HStack, Input, Spacer,Text} from "@chakra-ui/react"
...
export default function SignUp(){
    ...
    return (<>
        <Box pl={10} pr={10} pb={10} borderRight="1px solid #EAEAEA">
            ...
            <Button colorScheme={"blue"} mt="20px" mb="20px" width={"326px"} height="46px" fontWeight={"bold"}>Create Account</Button>
            <br />
            <hr color="#EAEAEA"/>
            
            <Button mt="20px" width={"326px"} height="46px" fontWeight={"bold"} color="#444444">Continue as Guest</Button>
            <Box mt="20px">
