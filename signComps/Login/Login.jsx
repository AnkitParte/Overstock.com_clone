import {Box, Button, FormControl, FormLabel, Input, Spacer} from "@chakra-ui/react"
...
export default function Login(){
    ...
    return (<>
        <Box pl={10} pr={10} pb={10}>
            ...
            <Button colorScheme={"green"} mt="20px" width={"326px"} height="46px" fontWeight={"bold"}>Sign In</Button>
